...
class Data3TestCase(unittest.TestCase):
    ...
    def test_battery_converter_devices(self):
        ...
        self.assertEqual(None, battery1.current_grm_in)
        self.assertEqual(None, battery1.current_grm_out)
        ...
        self.assertEqual(None, battery1.state_of_health)
        self.assertEqual(None, battery1.temperature_battery)
        self.assertEqual(529.5, battery1.voltage_grm_in)
        self.assertEqual(None, battery1.voltage_grm_out)
        self.assertEqual(None, battery1.voltage_battery_cell_mean)
        ...
        self.assertEqual(None, battery2.current_grm_in)
        self.assertEqual(None, battery2.current_grm_out)
        ...
        self.assertEqual(None, battery2.state_of_health)
        self.assertEqual(None, battery2.temperature_battery)
        self.assertEqual(631.0, battery2.voltage_grm_in)
        self.assertEqual(None, battery2.voltage_grm_out)
        self.assertEqual(None, battery2.voltage_battery_cell_mean)
        ...
        self.assertEqual(None, battery3.current_grm_in)
        self.assertEqual(None, battery3.current_grm_out)
        ...
        self.assertEqual(None, battery3.state_of_health)
        self.assertEqual(None, battery3.temperature_battery)
        self.assertEqual(596.1, battery3.voltage_grm_in)
        self.assertEqual(None, battery3.voltage_grm_out)
        self.assertEqual(None, battery3.voltage_battery_cell_mean)
